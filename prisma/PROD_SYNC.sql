-- À exécuter sur Supabase (SQL Editor) si l’app plante après une mise à jour Prisma
...
-- Note: Les colonnes relationnelles sont gérées par Prisma.
-- Si les erreurs persistent après ce SQL, forcez un 'npx prisma generate' local.
